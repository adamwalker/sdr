...
filterOne coeffs num inBuf outBuf = fill (VFS.generate num dotProd) outBuf
    where
    {-# INLINE dotProd #-}
...
filterCross coeffs num lastBuf nextBuf outBuf = fill (VFS.generate num dotProd) outBuf
    where
    {-# INLINE dotProd #-}
